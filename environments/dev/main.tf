...
metadata_startup_script = "sudo apt install docker.io -y && echo "AAAAAAAAAAAAAAAAAAAAAAAAAAAA" && sudo su -c 'gcloud auth configure-docker --quiet' && sudo docker pull gcr.io/my-first-project-310908/docker-app-3:latest && docker run -dp 3000:3000 gcr.io/my-first-project-310908/docker-app-3"
