...
metadata_startup_script = "sudo apt install docker.io -y && && sudo su && printf 'yes' | gcloud auth configure-docker && sudo docker pull gcr.io/my-first-project-310908/docker-app-3:latest && docker run -dp 3000:3000 gcr.io/my-first-project-310908/docker-app-3"
