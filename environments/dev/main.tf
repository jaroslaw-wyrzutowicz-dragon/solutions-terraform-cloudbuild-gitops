...
metadata_startup_script = "sudo su -c 'gcloud auth configure-docker --quiet' && sudo su -c 'docker pull gcr.io/my-first-project-310908/docker-app-3:latest' && sudo su -c 'docker run -dp 3000:3000 gcr.io/my-first-project-310908/docker-app-3'"
