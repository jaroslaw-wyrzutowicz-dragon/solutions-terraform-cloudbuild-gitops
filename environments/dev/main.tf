...
metadata_startup_script = "docker-credential-gcr configure-docker | sudo docker pull gcr.io/my-first-project-310908/docker-app-3:latest | sudo docker run -dp 3000:3000 docker-app-3"
